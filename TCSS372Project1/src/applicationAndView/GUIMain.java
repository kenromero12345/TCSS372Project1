...
public class GUIMain {
	 ...
	 * width of frame
	 */
	private static final int FRAMEWIDTH = 1060;
	 ...
	 */
	private static final int YFORPANEL = 10;
	 ...
	 */
	private static final int WIDTHFORPANEL_M = 315;
...
//		plusMinusJButton = new ArrayList<>();
	...
	public void setMemJPanel() {
		for (int i = 0; i < 50; i++) {
			...
			pan.setBounds(XFORPANEL_M, YFORPANEL + i * YGAPFORPANELS_R
					, WIDTHFORPANELS_R, HEIGHTFORPANELS_R);
